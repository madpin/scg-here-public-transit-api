...
class AllOfAccessPointPlaceLocation(Location):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfAccessPointPlaceLocation - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfAccessPointPlaceLocation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfAccessPointPlaceLocation):
            return False
