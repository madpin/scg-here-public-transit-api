...
import six
from here_public_transit_api.models.location import Location  # noqa: F401,E501

class AllOfChargingStationPlaceOriginalLocation(Location):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfChargingStationPlaceOriginalLocation - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfChargingStationPlaceOriginalLocation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfChargingStationPlaceOriginalLocation):
            return False
