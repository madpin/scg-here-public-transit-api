...
class TransitPreAction(object):
    ...
    discriminator_value_class_map = {
            'board'.lower(): '#/components/schemas/BoardAction',
    }

    def __init__(self):  # noqa: E501
        """TransitPreAction - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TransitPreAction, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TransitPreAction):
            return False
