...
class VehicleSpan(object):
    ...
    swagger_types = {
        ...
        'incidents': 'list[int]',
        'routing_zones': 'list[int]',
        'truck_road_types': 'list[int]',
        'notices': 'list[int]'
    }
    ...
    def __init__(self, offset=None, length=None, duration=None, street_attributes=None, walk_attributes=None, car_attributes=None, truck_attributes=None, scooter_attributes=None, toll_systems=None, names=None, route_numbers=None, country_code=None, functional_class=None, speed_limit=None, max_speed=None, dynamic_speed_info=None, segment_id=None, segment_ref=None, consumption=None, base_duration=None, typical_duration=None, incidents=None, routing_zones=None, truck_road_types=None, notices=None):  # noqa: E501
        """VehicleSpan - a model defined in Swagger"""  # noqa: E501
        self._offset = None
        self._length = None
        self._duration = None
    ...
    @property
    def offset(self):
        """Gets the offset of this VehicleSpan.  # noqa: E501

        Offset of a coordinate in the section's polyline.   # noqa: E501

        :return: The offset of this VehicleSpan.  # noqa: E501
        :rtype: int
        """
        return self._offset
    ...
    def offset(self, offset):
        """Sets the offset of this VehicleSpan.

        Offset of a coordinate in the section's polyline.   # noqa: E501

        :param offset: The offset of this VehicleSpan.  # noqa: E501
        :type: int
        """
    ...
    @property
    def length(self):
        """Gets the length of this VehicleSpan.  # noqa: E501


        :return: The length of this VehicleSpan.  # noqa: E501
        :rtype: Distance
        """
        return self._length
    ...
    def length(self, length):
        """Sets the length of this VehicleSpan.


        :param length: The length of this VehicleSpan.  # noqa: E501
        :type: Distance
        """
    ...
    @property
    def duration(self):
        """Gets the duration of this VehicleSpan.  # noqa: E501


        :return: The duration of this VehicleSpan.  # noqa: E501
        :rtype: Duration
        """
    ...
    def duration(self, duration):
        """Sets the duration of this VehicleSpan.


        :param duration: The duration of this VehicleSpan.  # noqa: E501
        :type: Duration
        """
    ...
    def street_attributes(self):
        """Gets the street_attributes of this VehicleSpan.  # noqa: E501
        ...
        :return: The street_attributes of this VehicleSpan.  # noqa: E501
    ...
    def street_attributes(self, street_attributes):
        """Sets the street_attributes of this VehicleSpan.

        `StreetAttributes` is applied to a span of a route section and describes attribute flags of a street. * `rightDrivingSide`: Vehicles have to drive on the right-hand side of the road. * `dirtRoad`: This part of the route has an un-paved surface. * `tunnel`: This part of the route is a tunnel. * `bridge`: This part of the route is a bridge. * `ramp`: This part of the route is a ramp (usually connecting to/from/between highways). * `motorway`: This part of the route is a controlled access road (usually highways with motorway sign). * `roundabout`: This part of the route is a roundabout. * `underConstruction`: This part of the route is under construction. * `dividedRoad`: This part of the route uses a road with a physical or legal divider in the middle. * `privateRoad`: This part of the route uses a privately owned road. * `controlledAccessHighway`: This part of the route is a either controlled access or limited access road or both.  As it is possible that new street attributes are supported in the future, unknown street attributes should be ignored.   # noqa: E501

        :param street_attributes: The street_attributes of this VehicleSpan.  # noqa: E501
    ...
    def walk_attributes(self):
        """Gets the walk_attributes of this VehicleSpan.  # noqa: E501
        ...
        :return: The walk_attributes of this VehicleSpan.  # noqa: E501
    ...
    def walk_attributes(self, walk_attributes):
        """Sets the walk_attributes of this VehicleSpan.

        Accessibility and walk-related attribute flags.  * `stairs`: This part of the route is a staircase. * `park`: This part of the route is in a park. * `indoor`: This part of the route is inside a venue. * `open`: This part of the route is open to walking. * `noThrough`: This part of the route can only be traversed if origin, destination or any via waypoint is located there. * `tollRoad`: Access to this part of the route is restricted with a fee (or toll).  As it is possible that new attributes are supported in the future, unknown attributes should be ignored.   # noqa: E501

        :param walk_attributes: The walk_attributes of this VehicleSpan.  # noqa: E501
    ...
    def car_attributes(self):
        """Gets the car_attributes of this VehicleSpan.  # noqa: E501

        Car specific `AccessAttributes`.  `AccessAttributes` is applied to a span of a route section and describes access flags of a street. * `open`: This part of the route is open to cars. * `noThrough`: This part of the route can only be traversed if origin, destination or any via waypoint is located there. * `tollRoad`: This part of the route is restricted with a fee (or toll).  As it is possible that new access attributes are supported in the future, unknown access attributes should be ignored.   # noqa: E501

        :return: The car_attributes of this VehicleSpan.  # noqa: E501
    ...
    def car_attributes(self, car_attributes):
        """Sets the car_attributes of this VehicleSpan.

        Car specific `AccessAttributes`.  `AccessAttributes` is applied to a span of a route section and describes access flags of a street. * `open`: This part of the route is open to cars. * `noThrough`: This part of the route can only be traversed if origin, destination or any via waypoint is located there. * `tollRoad`: This part of the route is restricted with a fee (or toll).  As it is possible that new access attributes are supported in the future, unknown access attributes should be ignored.   # noqa: E501

        :param car_attributes: The car_attributes of this VehicleSpan.  # noqa: E501
    ...
    def truck_attributes(self):
        """Gets the truck_attributes of this VehicleSpan.  # noqa: E501
        ...
        :return: The truck_attributes of this VehicleSpan.  # noqa: E501
        :rtype: list[AccessAttributes]
        """
    ...
    def truck_attributes(self, truck_attributes):
        """Sets the truck_attributes of this VehicleSpan.

        Truck specific `AccessAttributes`.  `AccessAttributes` is applied to a span of a route section and describes access flags of a street. * `open`: This part of the route is open to trucks. * `noThrough`: This part of the route can only be traversed if origin, destination or any via waypoint is located there. * `tollRoad`: This part of the route is restricted with a fee (or toll).  As it is possible that new access attributes are supported in the future, unknown access attributes should be ignored.   # noqa: E501

        :param truck_attributes: The truck_attributes of this VehicleSpan.  # noqa: E501
        :type: list[AccessAttributes]
        """
    ...
    def scooter_attributes(self):
        """Gets the scooter_attributes of this VehicleSpan.  # noqa: E501
        ...
        :return: The scooter_attributes of this VehicleSpan.  # noqa: E501
        :rtype: list[AccessAttributes]
        """
    ...
    def scooter_attributes(self, scooter_attributes):
        """Sets the scooter_attributes of this VehicleSpan.

        Scooter specific `AccessAttributes`.  `AccessAttributes` is applied to a span of a route section and describes access flags of a street. * `open`: This part of the route is open to scooters.  As it is possible that new access attributes are supported in the future, unknown access attributes should be ignored.   # noqa: E501

        :param scooter_attributes: The scooter_attributes of this VehicleSpan.  # noqa: E501
        :type: list[AccessAttributes]
        """
    ...
    def toll_systems(self):
        """Gets the toll_systems of this VehicleSpan.  # noqa: E501

        Specifies the toll systems of a toll (if any) applicable for this specific span. Since tolls are not static information, the tolls may or may not be applicable to the same span in different requests, depending on factors like transport mode, time of day, etc.  The contents of the array are reference indexes into the `tollSystems` array in the enclosing section.   # noqa: E501

        :return: The toll_systems of this VehicleSpan.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def toll_systems(self, toll_systems):
        """Sets the toll_systems of this VehicleSpan.

        Specifies the toll systems of a toll (if any) applicable for this specific span. Since tolls are not static information, the tolls may or may not be applicable to the same span in different requests, depending on factors like transport mode, time of day, etc.  The contents of the array are reference indexes into the `tollSystems` array in the enclosing section.   # noqa: E501

        :param toll_systems: The toll_systems of this VehicleSpan.  # noqa: E501
        :type: list[int]
        """
    ...
    @property
    def names(self):
        """Gets the names of this VehicleSpan.  # noqa: E501

        Designated name for the span (e.g. a street name or a transport name)  # noqa: E501

        :return: The names of this VehicleSpan.  # noqa: E501
    ...
    def names(self, names):
        """Sets the names of this VehicleSpan.

        Designated name for the span (e.g. a street name or a transport name)  # noqa: E501

        :param names: The names of this VehicleSpan.  # noqa: E501
    ...
    def route_numbers(self):
        """Gets the route_numbers of this VehicleSpan.  # noqa: E501

        Designated route name or number of the span (e.g. 'M25')  # noqa: E501

        :return: The route_numbers of this VehicleSpan.  # noqa: E501
        :rtype: list[LocalizedString]
        """
    ...
    def route_numbers(self, route_numbers):
        """Sets the route_numbers of this VehicleSpan.

        Designated route name or number of the span (e.g. 'M25')  # noqa: E501

        :param route_numbers: The route_numbers of this VehicleSpan.  # noqa: E501
        :type: list[LocalizedString]
        """
    ...
    def country_code(self):
        """Gets the country_code of this VehicleSpan.  # noqa: E501


        :return: The country_code of this VehicleSpan.  # noqa: E501
        :rtype: CountryCode
        """
    ...
    def country_code(self, country_code):
        """Sets the country_code of this VehicleSpan.


        :param country_code: The country_code of this VehicleSpan.  # noqa: E501
        :type: CountryCode
        """
    ...
    def functional_class(self):
        """Gets the functional_class of this VehicleSpan.  # noqa: E501


        :return: The functional_class of this VehicleSpan.  # noqa: E501
    ...
    def functional_class(self, functional_class):
        """Sets the functional_class of this VehicleSpan.


        :param functional_class: The functional_class of this VehicleSpan.  # noqa: E501
    ...
    def speed_limit(self):
        """Gets the speed_limit of this VehicleSpan.  # noqa: E501


        :return: The speed_limit of this VehicleSpan.  # noqa: E501
        :rtype: Speed
        """
    ...
    def speed_limit(self, speed_limit):
        """Sets the speed_limit of this VehicleSpan.


        :param speed_limit: The speed_limit of this VehicleSpan.  # noqa: E501
        :type: Speed
        """
    ...
    @property
    def max_speed(self):
        """Gets the max_speed of this VehicleSpan.  # noqa: E501


        :return: The max_speed of this VehicleSpan.  # noqa: E501
        :rtype: MaxSpeed
        """
    ...
    def max_speed(self, max_speed):
        """Sets the max_speed of this VehicleSpan.


        :param max_speed: The max_speed of this VehicleSpan.  # noqa: E501
        :type: MaxSpeed
        """
    ...
    def dynamic_speed_info(self):
        """Gets the dynamic_speed_info of this VehicleSpan.  # noqa: E501


        :return: The dynamic_speed_info of this VehicleSpan.  # noqa: E501
    ...
    def dynamic_speed_info(self, dynamic_speed_info):
        """Sets the dynamic_speed_info of this VehicleSpan.


        :param dynamic_speed_info: The dynamic_speed_info of this VehicleSpan.  # noqa: E501
    ...
    @property
    def segment_id(self):
        """Gets the segment_id of this VehicleSpan.  # noqa: E501
        ...
        **Disclaimer: This property is currently in beta release, and is therefore subject to breaking changes.**  The directed topology segment id including prefix (e.g '+here:cm:segment:').  The id consists of two parts. * The direction ('+' or '-') * followed by the topology segment id (a unique identifier within the HERE platform catalogs).  The direction specifies whether the route is using the segment in its canonical direction ('+' aka traveling along the geometry's direction), or against it ('-' aka traveling against the geometry's direction).   # noqa: E501
        ...
        :return: The segment_id of this VehicleSpan.  # noqa: E501
        :rtype: str
        """
    ...
    def segment_id(self, segment_id):
        """Sets the segment_id of this VehicleSpan.

        **Disclaimer: This property is currently in beta release, and is therefore subject to breaking changes.**  The directed topology segment id including prefix (e.g '+here:cm:segment:').  The id consists of two parts. * The direction ('+' or '-') * followed by the topology segment id (a unique identifier within the HERE platform catalogs).  The direction specifies whether the route is using the segment in its canonical direction ('+' aka traveling along the geometry's direction), or against it ('-' aka traveling against the geometry's direction).   # noqa: E501

        :param segment_id: The segment_id of this VehicleSpan.  # noqa: E501
        :type: str
        """
    ...
    def segment_ref(self):
        """Gets the segment_ref of this VehicleSpan.  # noqa: E501
        ...
        :return: The segment_ref of this VehicleSpan.  # noqa: E501
        :rtype: str
        """
    ...
    def segment_ref(self, segment_ref):
        """Sets the segment_ref of this VehicleSpan.

        A reference to the HMC topology segment used in this span.  The standard representation of a segment reference has the following structure: {catalogHrn}:{catalogVersion}:({layerId})?:{tileId}:{segmentId}(#{direction}({startOffset}..{endOffset})?)?  The individual parts are: * catalogHrn: The HERE Resource Name that identifies the source catalog of the segment, example: hrn:here:data::olp-here:rib-2 * catalogVersion: The catalog version * layerId (optional): The layer inside the catalog where the segment can be found, example: topology-geometry * tileId: The HERE tile key of the partition/tile where the segment is located in the given version of the catalog. This can be on a lower level than the actual segment is stored at (for example, the provided tile ID can be on level 14, despite topology-geometry partitions being tiled at level 12). The level of a HERE tile key is indicated by the position of the highest set bit in binary representation. Since the HERE tile key represents a morton code of the x and y portion of the Tile ID, the level 12 tile ID can be retrieved from the level 14 tile ID by removing the 4 least significant bits (or 2 bits per level) or 1 hexidecimal digit. For example, the level 14 tile 377894441 is included in the level 12 tile 23618402 (377894441<sub>10</sub> = 16863629<sub>16</sub> &rightarrow; 1686362<sub>16</sub> = 23618402<sub>10</sub>) * segmentId: The identifier of the referenced topology segment inside the catalog, example: here:cm:segment:84905195 * direction (optional): Either '*' for undirected or bidirectional, '+' for positive direction, '-' for negative direction, or '?' for unknown direction (not used by the routing service) * startOffset/endOffset (optional): The start- and end offset are non-negative numbers between 0 and 1, representing the start and end of the referenced range using a proportion of the length of the segment. 0 represents the start and 1 the end of the segment, relative to the indicated direction (or positive direction in case of undirected segments). Example: 0.7..1  Example of a segment reference in standard representation: hrn:here:data::olp-here:rib-2:1363::377894441:here:cm:segment:84905195#+0.7..1  The segment references can also be provided in a compact representation, to reduce the response size. In the compact representation, some parts are replaced by placeholders, which can be resolved using the refReplacements dictionary in the parent section. The placeholder format is \\$\\d+ and need to be surrounded by columns or string start/end. It can be captured with the following regular expression: (^|:)\\$\\d+(:|$)  Example of the segment reference previously mentioned in compact representation: $0:377894441:$1:84905195#+0.7..1 With the corresponding refReplacements: \"refReplacements\": {   \"0\": \"hrn:here:data::olp-here:rib-2:1363:\",   \"1\": \"here:cm:segment\" }   # noqa: E501

        :param segment_ref: The segment_ref of this VehicleSpan.  # noqa: E501
        :type: str
        """
    ...
    def consumption(self):
        """Gets the consumption of this VehicleSpan.  # noqa: E501


        :return: The consumption of this VehicleSpan.  # noqa: E501
        :rtype: Energy
        """
    ...
    def consumption(self, consumption):
        """Sets the consumption of this VehicleSpan.


        :param consumption: The consumption of this VehicleSpan.  # noqa: E501
        :type: Energy
        """
    ...
    def base_duration(self):
        """Gets the base_duration of this VehicleSpan.  # noqa: E501


        :return: The base_duration of this VehicleSpan.  # noqa: E501
        :rtype: Duration
        """
    ...
    def base_duration(self, base_duration):
        """Sets the base_duration of this VehicleSpan.


        :param base_duration: The base_duration of this VehicleSpan.  # noqa: E501
        :type: Duration
        """
    ...
    def typical_duration(self):
        """Gets the typical_duration of this VehicleSpan.  # noqa: E501


        :return: The typical_duration of this VehicleSpan.  # noqa: E501
        :rtype: Duration
        """
    ...
    def typical_duration(self, typical_duration):
        """Sets the typical_duration of this VehicleSpan.


        :param typical_duration: The typical_duration of this VehicleSpan.  # noqa: E501
        :type: Duration
        """
    ...
    @property
    def incidents(self):
        """Gets the incidents of this VehicleSpan.  # noqa: E501

        A list of indices into the incident array of the parent section. References all incidents that apply to the span. This requires `incidents` to be specified as part of the `return` parameter.   # noqa: E501

        :return: The incidents of this VehicleSpan.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def incidents(self, incidents):
        """Sets the incidents of this VehicleSpan.

        A list of indices into the incident array of the parent section. References all incidents that apply to the span. This requires `incidents` to be specified as part of the `return` parameter.   # noqa: E501

        :param incidents: The incidents of this VehicleSpan.  # noqa: E501
        :type: list[int]
        """
    ...
    def routing_zones(self):
        """Gets the routing_zones of this VehicleSpan.  # noqa: E501

        A list of indices into the routing zone array of the parent section. References all applicable routing zones to the span.   # noqa: E501

        :return: The routing_zones of this VehicleSpan.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def routing_zones(self, routing_zones):
        """Sets the routing_zones of this VehicleSpan.

        A list of indices into the routing zone array of the parent section. References all applicable routing zones to the span.   # noqa: E501

        :param routing_zones: The routing_zones of this VehicleSpan.  # noqa: E501
        :type: list[int]
        """
    ...
    def truck_road_types(self):
        """Gets the truck_road_types of this VehicleSpan.  # noqa: E501

        A list of indices into the truck road types array of the parent section. References all applicable truck road types to the span.  # noqa: E501

        :return: The truck_road_types of this VehicleSpan.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def truck_road_types(self, truck_road_types):
        """Sets the truck_road_types of this VehicleSpan.

        A list of indices into the truck road types array of the parent section. References all applicable truck road types to the span.  # noqa: E501

        :param truck_road_types: The truck_road_types of this VehicleSpan.  # noqa: E501
        :type: list[int]
        """
    ...
    @property
    def notices(self):
        """Gets the notices of this VehicleSpan.  # noqa: E501

        A list of indices into the notices array of the parent section. References all notices that apply to the span.   # noqa: E501

        :return: The notices of this VehicleSpan.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def notices(self, notices):
        """Sets the notices of this VehicleSpan.

        A list of indices into the notices array of the parent section. References all notices that apply to the span.   # noqa: E501

        :param notices: The notices of this VehicleSpan.  # noqa: E501
        :type: list[int]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(VehicleSpan, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VehicleSpan):
            return False
