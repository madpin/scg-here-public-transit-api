...
from here_public_transit_api.models.version_response import VersionResponse  # noqa: E501
...
class TestVersionResponse(unittest.TestCase):
    ...
    def testVersionResponse(self):
        ...
        # model = here_public_transit_api.models.version_response.VersionResponse()  # noqa: E501
        pass
