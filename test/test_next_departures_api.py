...
from here_public_transit_api.api.next_departures_api import NextDeparturesApi  # noqa: E501
from here_public_transit_api.rest import ApiException


class TestNextDeparturesApi(unittest.TestCase):
    """NextDeparturesApi unit test stubs"""

    def setUp(self):
        self.api = NextDeparturesApi()  # noqa: E501
